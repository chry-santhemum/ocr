...
from data_scripts.locations import TrainDatasetConfig, generate_train_dataset
...
def finetune(args):
    client = OpenAI()
    train_df, valid_df = generate_data(args)
...
def generate_data(args):
    ...
    train_ds_config = TrainDatasetConfig(**json.loads(args.train_data_config))
    train_df = generate_train_dataset(train_ds_config)
    ...
    valid_df = get_eval_dataset(args.valid_type, valid_config_dict, df_to_not_overlap_with=train_df, train_df=train_df)
